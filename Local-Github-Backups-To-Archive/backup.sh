...
ARCHIVE_NAME="github-repos-backup-$DATE.tar.gz" 
...
tar -czf $ARCHIVE_NAME -C $BACKUP_BASE_DIR $DATE

rm -rf $BACKUP_DIR

echo "Backup completed. Repositories have been archived to $ARCHIVE_NAME."
